# Paysafe Payments Demo

This demo features a sample payment page that uses [PaysafeJS](https://developer.paysafe.com/en/sdks/paysafejs/overview/), [PaysafeCheckout](https://developer.paysafe.com/en/sdks/paysafe-checkout/overview/) and the [APMs API](https://developer.paysafe.com/en/rest-api/alternate-payments/getting-started/overview/) to illustrate how to accept both card payments and additional payment methods on the web.

If you’re running a compatible browser, this demo also showcases the [Payment Request API](https://stripe.com/docs/payment-request-api), [Apple Pay](https://stripe.com/docs/apple-pay), and [Google Pay](https://developer.paysafe.com/en/sdks/mobile/android/introduction-to-google-pay/) for a seamless payment experience.

**You can see this demo app running in test mode on [paysafe-payments-demo.appspot.com](https://paysafe-payments-demo.appspot.com).**
